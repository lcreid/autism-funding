...
ActiveRecord::Schema.define(version: 20_170_125_212_526) do
  ...
  create_table 'invoice_allocations', id: false, force: :cascade do |t|
    ...
    t.index %w(cf0925_id invoice_id), name: 'index_invoice_allocations_on_cf0925_id_and_invoice_id', using: :btree
    t.index ['cf0925_id'], name: 'index_invoice_allocations_on_cf0925_id', using: :btree
    t.index %w(invoice_id cf0925_id), name: 'index_invoice_allocations_on_invoice_id_and_cf0925_id', using: :btree
