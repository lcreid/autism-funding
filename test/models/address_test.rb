...
class AddressTest < ActiveSupport::TestCase
  ...
  test testName do
    ...
    expected = test_province.province_code.to_s
    assert_equal expected, test_address.get_province_code, '03.d: get_province_code error'

    # 03.e .....................................................................
    test_address.province_code = test_province
    expected = test_province.province_name.to_s
    ...
    # 03.k .....................................................................
    expected = test_address1.strip.to_s
  ...
  test 'Frozen strings' do
    a = Address.new
    a.user = User.new(email: 'a@weenhanceit.com')
    a.city = ' New Delhi '
    a.city.freeze
    a.address_line_1 = ' 123   Main st.   '
    a.address_line_1.freeze
    a.postal_code = ' T5Z 1T3  '
    a.postal_code.freeze
    assert a.save, "Failed to save address: #{a.errors.full_messages}"
  end
end
